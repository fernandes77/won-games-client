...
export const Logo = ({
  ...
  const isMobile = useMediaQuery('max', 767)
  const shouldApplyHideOnMobile = isMobile && hideTextOnMobile
  ...
  return (
    <div className={`${colorClasses} ${sizeClasses}`}>
      <svg
        ...
        className={
          shouldApplyHideOnMobile ? `h-11 pointer-events-none` : undefined
        }
      >
        <path
        ...
        <path
          ...
          className={shouldApplyHideOnMobile ? 'hidden' : undefined}
          fill="currentColor"
